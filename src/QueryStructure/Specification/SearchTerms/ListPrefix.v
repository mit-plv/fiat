...
Section PrefixClauses.
  ...
  Proof.
    econstructor 1 with (dec := fun a => ?[IsPrefix_dec st a]).
    prefix_crush.
  Defined.
  ...
  Proof.
    econstructor 1 with (dec := fun a => ?[IsPrefix_dec b (f a)]).
    prefix_crush.
  Defined.
  ...
  Proof.
    econstructor 1 with (dec := fun a =>  ?[IsPrefix_dec a st]).
    prefix_crush.
  Defined.
  ...
  Proof.
    econstructor 1 with (dec := fun a => ?[IsPrefix_dec (f a) b]).
    prefix_crush.
  Defined.
