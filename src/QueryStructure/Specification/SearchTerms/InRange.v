...
Section RangeClause.
  ...
  Proof.
    refine {| dec a := ?[InRange_dec a minRange maxRange] |}.
  ...
  Proof.
    refine {| dec a := ?[InRange_dec (f a) minRange maxRange ] |}.
