...
Proof.
  ...
  match goal with
  | [ H : List.In _ _ |- _ ] =>
      rewrite in_map_iff in H; destruct_ex; intuition; subst
  end.
  match goal with
  | [ H : List.In _ _, ValidBound : forall element : IndexedElement, _ |- _ ] =>
      apply equiv in H2; apply ValidBound in H2; destruct x; simpl in *; omega
  end.
