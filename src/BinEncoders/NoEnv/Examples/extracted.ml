...
let unpacking_decoder project encode1 encode2 decoder1 decoder2 bin =
...
let strengthening_decoder encode_data data_decoder =
...
let fixInt_encode_inner size0 n0 =
...
let fixInt_eq_dec size0 n0 m =
  N.eq_dec n0 m

(** val fixInt_encode : nat -> (n*bin_t) -> bool list **)

let fixInt_encode size0 =
  bin_encode_transform_pair (fixInt_encode_inner size0)

(** val fixInt_decoder : nat -> (n*bin_t, bool list) decoder **)

let fixInt_decoder size0 =
  bin_encode_transform_pair_decoder (fixInt_encode_inner size0)
    (fixInt_decode size0)
...
let char_encode_inner c =
  fixInt_encode_inner (S (S (S (S (S (S (S (S O)))))))) (n_of_ascii c)
...
let char_decoder =
  bin_encode_transform_pair_decoder char_encode_inner char_decode

(** val bool_encode_inner : bool -> bin_t **)

let bool_encode_inner b =
  b::[]
...
let bool_decoder =
  bin_encode_transform_pair_decoder bool_encode_inner bool_decode
...
let encode_word bundle =
  fixInt_encode (S (S (S (S (S (S (S (S O))))))))
    ((fixList_getlength (S (S (S (S (S (S (S (S O))))))))
       (word_attr (fst bundle))),(fixList_encode (S (S (S (S (S (S (S (S
                                   O)))))))) char_encode
                                   ((word_attr (fst bundle)),(snd bundle))))

(** val encode_name : (name_t*bin_t) -> bin_t **)

let encode_name bundle =
  steppingList_encode halt (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
    ...
    (S (S (S (S (S (S (S (S (S
    O)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
    encode_word ((name_attr (fst bundle)),(snd bundle))

(** val encode_question : (question_t*bin_t) -> bin_t **)

let encode_question bundle =
  encode_name
    ((fst bundle).qname,(fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S
                          (S (S (S (S O))))))))))))))))
                          ((fixInt_of_type (fst bundle).qtype),(fixInt_encode
                                                                 (S (S (S
                                                                 (S (S (S
                                                                 (S (S (S
                                                                 (S (S (S
...
let encode_resource bundle =
  encode_name
    ((fst bundle).rname,(fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S
                          (S (S (S (S O))))))))))))))))
                          ((fixInt_of_type (fst bundle).rtype),(fixInt_encode
                                                                 (S (S (S
                                                                 (S (S (S
                                                                 (S (S (S
                                                                 (S (S (S
...
let encode_packet bundle =
  fixList2_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
    O)))))))))))))))) bool_encode
    ((fst bundle).pid,(fixList2_encode (S (S (S (S (S (S (S (S (S (S (S (S
                        (S (S (S (S O)))))))))))))))) bool_encode
                        ((fst bundle).pmask,(fixInt_encode (S (S (S (S (S
                                              (S (S (S (S (S (S (S (S (S
                                              (S (S O))))))))))))))))
                                              ((fixList_getlength (S (S (S
                                                 (S (S (S (S (S (S (S (S
                                                 (S (S (S (S (S
                                                 O))))))))))))))))
                                                 (fst bundle).pquestion),
                                              (fixInt_encode (S (S (S (S
                                                (S (S (S (S (S (S (S (S (S
                                                (S (S (S O))))))))))))))))
                                                ((fixList_getlength (S (S
                                                   (S (S (S (S (S (S (S (S
                                                   (S (S (S (S (S (S
                                                   O))))))))))))))))
                                                   (fst bundle).panswer),
...
let type_to_FixInt_decoder n0 =
  if fixInt_eq_dec (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
       O)))))))))))))))) n0 (Npos XH)
  then A
  else if fixInt_eq_dec (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
            O)))))))))))))))) n0 (Npos (XI (XO XH)))
       then CNAME
       else if fixInt_eq_dec (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
                 (S O)))))))))))))))) n0 (Npos (XO XH))
            then NS
            else MX
...
let word_decoder =
  unpacking_decoder (fun bundle ->
    fixList_getlength (S (S (S (S (S (S (S (S O))))))))
      (word_attr (fst bundle))) (fun bundle ->
    fixInt_encode (S (S (S (S (S (S (S (S O))))))))
      ((fst bundle),(snd bundle))) (fun bundle ->
    fixList_encode (S (S (S (S (S (S (S (S O)))))))) char_encode
      ((word_attr (fst bundle)),(snd bundle)))
    (strengthening_decoder
      (fixInt_encode (S (S (S (S (S (S (S (S O)))))))))
      (fixInt_decoder (S (S (S (S (S (S (S (S O)))))))))) (fun proj ->
    unpacking_decoder (fun bundle -> word_attr (fst bundle))
      (fun bundle ->
      fixList_encode (S (S (S (S (S (S (S (S O)))))))) char_encode
        ((fst bundle),(snd bundle))) (fun bundle -> snd bundle)
      (strengthening_decoder
        (fixList_encode (S (S (S (S (S (S (S (S O)))))))) char_encode)
        (fixList_decoder (S (S (S (S (S (S (S (S O)))))))) proj
          char_encode (strengthening_decoder char_encode char_decoder)))
      (fun proj0 b -> proj0,b))

(** val name_decoder : (name_t*bin_t, bin_t) decoder **)

let name_decoder =
  unpacking_decoder (fun bundle -> name_attr (fst bundle)) (fun bundle ->
    steppingList_encode halt (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
      (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
      (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
      (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
      (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
      ...
      (S (S (S (S (S (S (S (S (S (S
      O)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
      encode_word ((fst bundle),(snd bundle))) (fun bundle -> snd bundle)
    (strengthening_decoder
      (steppingList_encode halt (S (S (S (S (S (S (S (S (S (S (S (S (S (S
        ...
        O)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
        encode_word)
      (steppingList_decoder halt (fun a -> halt_dec a) (S (S (S (S (S (S
        (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
        (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
        (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
        (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
        ...
        (S (S (S (S (S (S (S
        O)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
        encode_word (strengthening_decoder encode_word word_decoder)))
    (fun proj b -> proj,b)

(** val question_decoder : (question_t*bin_t, bin_t) decoder **)

let question_decoder =
  unpacking_decoder (fun bundle -> (fst bundle).qname) (fun bundle ->
    encode_name ((fst bundle),(snd bundle))) (fun bundle ->
    fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
      O))))))))))))))))
      ((fixInt_of_type (fst bundle).qtype),(fixInt_encode (S (S (S (S (S
                                             (S (S (S (S (S (S (S (S (S (S
                                             (S O))))))))))))))))
                                             ((fixInt_of_class
                                                (fst bundle).qclass),
                                             (snd bundle)))))
    (strengthening_decoder encode_name name_decoder) (fun proj ->
    unpacking_decoder (fun bundle -> (fst bundle).qtype) (fun bundle ->
      fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
        O)))))))))))))))) ((fixInt_of_type (fst bundle)),(snd bundle)))
      (fun bundle ->
      fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
        O))))))))))))))))
        ((fixInt_of_class (fst bundle).qclass),(snd bundle)))
      (strengthening_decoder (fun bundle ->
        fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
          O)))))))))))))))) ((fixInt_of_type (fst bundle)),(snd bundle)))
        (nesting_decoder (fun a -> (fixInt_of_type (fst a)),(snd a))
          (fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
            O)))))))))))))))))
          (unproding_decoder fixInt_of_type type_to_FixInt_decoder)
          (fixInt_decoder (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
            O))))))))))))))))))) (fun proj0 ->
      unpacking_decoder (fun bundle -> (fst bundle).qclass) (fun bundle ->
        fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
          O)))))))))))))))) ((fixInt_of_class (fst bundle)),(snd bundle)))
        (fun bundle -> snd bundle)
        (strengthening_decoder (fun bundle ->
          fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
            O))))))))))))))))
            ((fixInt_of_class (fst bundle)),(snd bundle)))
          (nesting_decoder (fun a -> (fixInt_of_class (fst a)),(snd a))
            (fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
              O)))))))))))))))))
            (unproding_decoder fixInt_of_class class_to_FixInt_decoder)
            (fixInt_decoder (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
              (S O))))))))))))))))))) (fun proj1 b -> { qname = proj;
        qtype = proj0; qclass = proj1 },b)))

(** val resource_decoder : (resource_t*bin_t, bin_t) decoder **)

let resource_decoder =
  unpacking_decoder (fun bundle -> (fst bundle).rname) (fun bundle ->
    encode_name ((fst bundle),(snd bundle))) (fun bundle ->
    fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
      O))))))))))))))))
      ((fixInt_of_type (fst bundle).rtype),(fixInt_encode (S (S (S (S (S
                                             (S (S (S (S (S (S (S (S (S (S
                                             (S O))))))))))))))))
                                             ((fixInt_of_class
                                                (fst bundle).rclass),
                                             (fixInt_encode (S (S (S (S (S
                                               ...
                                               (fixInt_encode (S (S (S (S
                                                 ...
                                                 (fixList_encode (S (S (S
                                                   ...
                                                   (snd bundle)))))))))))
    (strengthening_decoder encode_name name_decoder) (fun proj ->
    unpacking_decoder (fun bundle -> (fst bundle).rtype) (fun bundle ->
      fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
        O)))))))))))))))) ((fixInt_of_type (fst bundle)),(snd bundle)))
      (fun bundle ->
      fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
        O))))))))))))))))
        ((fixInt_of_class (fst bundle).rclass),(fixInt_encode (S (S (S (S
                                                 (S (S (S (S (S (S (S (S
                                                 (S (S (S (S (S (S (S (S
                                                 (S (S (S (S (S (S (S (S
                                                 (S (S (S (S
      ...
      (strengthening_decoder (fun bundle ->
        ...
        (nesting_decoder (fun a -> (fixInt_of_type (fst a)),(snd a))
          ...
          (fixInt_decoder (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
            O))))))))))))))))))) (fun proj0 ->
      unpacking_decoder (fun bundle -> (fst bundle).rclass) (fun bundle ->
        fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
          O)))))))))))))))) ((fixInt_of_class (fst bundle)),(snd bundle)))
        (fun bundle ->
        fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
          (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
          O))))))))))))))))))))))))))))))))
          ((fst bundle).rttl,(fixInt_encode (S (S (S (S (S (S (S (S (S (S
                               (S (S (S (S (S (S O))))))))))))))))
                               ((fixList_getlength (S (S (S (S (S (S (S (S
                                  (S (S (S (S (S (S (S (S
                                  O)))))))))))))))) (fst bundle).rdata),
                               (fixList_encode (S (S (S (S (S (S (S (S (S
                                 (S (S (S (S (S (S (S O))))))))))))))))
                                 bool_encode
                                 ((fst bundle).rdata,(snd bundle)))))))
        (strengthening_decoder (fun bundle ->
          fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
            O))))))))))))))))
            ((fixInt_of_class (fst bundle)),(snd bundle)))
          (nesting_decoder (fun a -> (fixInt_of_class (fst a)),(snd a))
            ...
            (fixInt_decoder (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
              (S O))))))))))))))))))) (fun proj1 ->
        unpacking_decoder (fun bundle -> (fst bundle).rttl) (fun bundle ->
          fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
            (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
            O)))))))))))))))))))))))))))))))) ((fst bundle),(snd bundle)))
          (fun bundle ->
          fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
            O))))))))))))))))
            ((fixList_getlength (S (S (S (S (S (S (S (S (S (S (S (S (S (S
               (S (S O)))))))))))))))) (fst bundle).rdata),(fixList_encode
                                                             (S (S (S (S
                                                             (S (S (S (S
                                                             (S (S (S (S
                                                             (S (S (S (S
          ...
          unpacking_decoder (fun bundle ->
            fixList_getlength (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
              (S O)))))))))))))))) (fst bundle).rdata) (fun bundle ->
            fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
              O)))))))))))))))) ((fst bundle),(snd bundle)))
            (fun bundle ->
            fixList_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
              O)))))))))))))))) bool_encode
              ((fst bundle).rdata,(snd bundle)))
            (strengthening_decoder
              ...
              (fixInt_decoder (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
                (S O)))))))))))))))))) (fun proj3 ->
            unpacking_decoder (fun bundle -> (fst bundle).rdata)
              (fun bundle ->
              ...
              (strengthening_decoder
                ...
                (fixList_decoder (S (S (S (S (S (S (S (S (S (S (S (S (S (S
                  (S (S O)))))))))))))))) proj3 bool_encode
                  (strengthening_decoder bool_encode bool_decoder)))
              (fun proj4 b -> { rname = proj; rtype = proj0; rclass =
              proj1; rttl = proj2; rdata = proj4 },b))))))

(** val packet_decoder : (packet_t*bin_t, bin_t) decoder **)

let packet_decoder =
  unpacking_decoder (fun bundle -> (fst bundle).pid) (fun bundle ->
    fixList2_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
      O)))))))))))))))) bool_encode ((fst bundle),(snd bundle)))
    (fun bundle ->
    fixList2_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
      O)))))))))))))))) bool_encode
      ((fst bundle).pmask,(fixInt_encode (S (S (S (S (S (S (S (S (S (S (S
                            (S (S (S (S (S O))))))))))))))))
                            ((fixList_getlength (S (S (S (S (S (S (S (S (S
                               (S (S (S (S (S (S (S O))))))))))))))))
                               (fst bundle).pquestion),(fixInt_encode (S
                                                         (S (S (S (S (S (S
                                                         (S (S (S (S (S (S
                                                         (S (S (S
                                                         O))))))))))))))))
    ...
    (strengthening_decoder
      ...
      (fixList2_decoder (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
        O)))))))))))))))) bool_encode
        (strengthening_decoder bool_encode bool_decoder))) (fun proj ->
    unpacking_decoder (fun bundle -> (fst bundle).pmask) (fun bundle ->
      fixList2_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
        O)))))))))))))))) bool_encode ((fst bundle),(snd bundle)))
      (fun bundle ->
      fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
        O))))))))))))))))
        ((fixList_getlength (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
           (S O)))))))))))))))) (fst bundle).pquestion),(fixInt_encode (S
                                                          (S (S (S (S (S
                                                          (S (S (S (S (S
                                                          (S (S (S (S (S
                                                          O))))))))))))))))
      ...
      (strengthening_decoder
        ...
        (fixList2_decoder (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
          O)))))))))))))))) bool_encode
          (strengthening_decoder bool_encode bool_decoder))) (fun proj0 ->
      unpacking_decoder (fun bundle ->
        fixList_getlength (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
          O)))))))))))))))) (fst bundle).pquestion) (fun bundle ->
        fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
          O)))))))))))))))) ((fst bundle),(snd bundle))) (fun bundle ->
        fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
          O))))))))))))))))
          ((fixList_getlength (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
             (S O)))))))))))))))) (fst bundle).panswer),(fixInt_encode (S
                                                          (S (S (S (S (S
                                                          (S (S (S (S (S
                                                          (S (S (S (S (S
                                                          O))))))))))))))))
        ...
        unpacking_decoder (fun bundle ->
          fixList_getlength (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
            (S O)))))))))))))))) (fst bundle).panswer) (fun bundle ->
          fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
            O)))))))))))))))) ((fst bundle),(snd bundle))) (fun bundle ->
          fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
            O))))))))))))))))
            ((fixList_getlength (S (S (S (S (S (S (S (S (S (S (S (S (S (S
               (S (S O)))))))))))))))) (fst bundle).pauthority),(fixInt_encode
                                                                 (S (S (S
                                                                 (S (S (S
                                                                 (S (S (S
                                                                 (S (S (S
          ...
          unpacking_decoder (fun bundle ->
            fixList_getlength (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
              (S O)))))))))))))))) (fst bundle).pauthority) (fun bundle ->
            fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
              O)))))))))))))))) ((fst bundle),(snd bundle)))
            (fun bundle ->
            fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
              ...
              ((fixList_getlength (S (S (S (S (S (S (S (S (S (S (S (S (S
                 (S (S (S O)))))))))))))))) (fst bundle).padditional),
              (fixList_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
                (S O)))))))))))))))) encode_question
                ((fst bundle).pquestion,(fixList_encode (S (S (S (S (S (S
                                          (S (S (S (S (S (S (S (S (S (S
                                          O))))))))))))))))
                                          encode_resource
                                          ((fst bundle).panswer,(fixList_encode
                                                                 (S (S (S
                                                                 (S (S (S
                                                                 (S (S (S
                                                                 (S (S (S
            ...
            unpacking_decoder (fun bundle ->
              fixList_getlength (S (S (S (S (S (S (S (S (S (S (S (S (S (S
                (S (S O)))))))))))))))) (fst bundle).padditional)
              (fun bundle ->
              fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
                (S O)))))))))))))))) ((fst bundle),(snd bundle)))
              (fun bundle ->
              fixList_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S (S
                (S O)))))))))))))))) encode_question
                ((fst bundle).pquestion,(fixList_encode (S (S (S (S (S (S
              ...
              (strengthening_decoder
                (fixInt_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S
                  (S (S O)))))))))))))))))
                (fixInt_decoder (S (S (S (S (S (S (S (S (S (S (S (S (S (S
                  (S (S O)))))))))))))))))) (fun proj4 ->
              unpacking_decoder (fun bundle -> (fst bundle).pquestion)
                (fun bundle ->
                fixList_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S
                  (S (S O)))))))))))))))) encode_question
                  ((fst bundle),(snd bundle))) (fun bundle ->
                fixList_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S
                  (S (S O)))))))))))))))) encode_resource
                  ((fst bundle).panswer,(fixList_encode (S (S (S (S (S (S
                                          (S (S (S (S (S (S (S (S (S (S
                                          O))))))))))))))))
                                          encode_resource
                                          ((fst bundle).pauthority,
                                          (fixList_encode (S (S (S (S (S
                                            (S (S (S (S (S (S (S (S (S (S
                                            (S O))))))))))))))))
                                            encode_resource
                                            ((fst bundle).padditional,
                ...
                (strengthening_decoder
                  ...
                  (fixList_decoder (S (S (S (S (S (S (S (S (S (S (S (S (S
                    (S (S (S O)))))))))))))))) proj1 encode_question
                    (strengthening_decoder encode_question
                      question_decoder))) (fun proj5 ->
                unpacking_decoder (fun bundle -> (fst bundle).panswer)
                  (fun bundle ->
                  fixList_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S
                    (S (S O)))))))))))))))) encode_resource
                    ((fst bundle),(snd bundle))) (fun bundle ->
                  fixList_encode (S (S (S (S (S (S (S (S (S (S (S (S (S (S
                    (S (S O)))))))))))))))) encode_resource
                    ((fst bundle).pauthority,(fixList_encode (S (S (S (S
                                               (S (S (S (S (S (S (S (S (S
                                               (S (S (S O))))))))))))))))
                                               encode_resource
                                               ((fst bundle).padditional,
                  ...
                  (strengthening_decoder
                    (fixList_encode (S (S (S (S (S (S (S (S (S (S (S (S (S
                      (S (S (S O)))))))))))))))) encode_resource)
                    (fixList_decoder (S (S (S (S (S (S (S (S (S (S (S (S
                      (S (S (S (S O)))))))))))))))) proj2 encode_resource
                      (strengthening_decoder encode_resource
                        resource_decoder))) (fun proj6 ->
                  unpacking_decoder (fun bundle ->
                    (fst bundle).pauthority) (fun bundle ->
                    fixList_encode (S (S (S (S (S (S (S (S (S (S (S (S (S
                      (S (S (S O)))))))))))))))) encode_resource
                      ((fst bundle),(snd bundle))) (fun bundle ->
                    fixList_encode (S (S (S (S (S (S (S (S (S (S (S (S (S
                      (S (S (S O)))))))))))))))) encode_resource
                      ((fst bundle).padditional,(snd bundle)))
                    (strengthening_decoder
                      (fixList_encode (S (S (S (S (S (S (S (S (S (S (S (S
                        (S (S (S (S O)))))))))))))))) encode_resource)
                      (fixList_decoder (S (S (S (S (S (S (S (S (S (S (S (S
                        (S (S (S (S O)))))))))))))))) proj3
                        encode_resource
                        (strengthening_decoder encode_resource
                          resource_decoder))) (fun proj7 ->
                    unpacking_decoder (fun bundle ->
                      (fst bundle).padditional) (fun bundle ->
                      fixList_encode (S (S (S (S (S (S (S (S (S (S (S (S
                        (S (S (S (S O)))))))))))))))) encode_resource
                        ((fst bundle),(snd bundle))) (fun bundle ->
                      snd bundle)
                      (strengthening_decoder
                        (fixList_encode (S (S (S (S (S (S (S (S (S (S (S
                          (S (S (S (S (S O))))))))))))))))
                          encode_resource)
                        (fixList_decoder (S (S (S (S (S (S (S (S (S (S (S
                          (S (S (S (S (S O)))))))))))))))) proj4
                          encode_resource
                          (strengthening_decoder encode_resource
                            resource_decoder))) (fun proj8 b -> { pid =
                      proj; pmask = proj0; pquestion = proj5; panswer =
                      proj6; pauthority = proj7; padditional = proj8 },b))))))))))

(** val packet1 : bool list **)

let packet1 =
  true::(true::(false::(true::(true::(false::(true::(true::(false::(true::(false::(false::(false::(false::(true::(false::(false::(false::(false::(false::(false::(false::(false::(true::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(true::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(true::(true::(false::(true::(true::(true::(false::(true::(true::(true::(false::(true::(true::(true::(false::(true::(true::(true::(false::(true::(true::(true::(false::(true::(true::(true::(false::(false::(false::(false::(true::(true::(false::(false::(false::(true::(true::(false::(true::(true::(true::(false::(false::(true::(true::(false::(true::(true::(true::(true::(false::(true::(true::(true::(false::(false::(true::(false::(false::(true::(true::(true::(false::(true::(false::(false::(false::(true::(true::(false::(true::(false::(false::(false::(false::(true::(true::(false::(false::(true::(false::(true::(false::(true::(true::(false::(false::(false::(false::(true::(false::(true::(true::(true::(false::(false::(true::(true::(false::(true::(true::(true::(false::(true::(false::(false::(false::(true::(true::(false::(false::(true::(false::(true::(false::(true::(true::(true::(false::(false::(true::(false::(false::(true::(true::(false::(true::(true::(true::(false::(false::(false::(false::(false::(false::(false::(true::(true::(false::(true::(true::(false::(false::(true::(false::(true::(false::(true::(true::(false::(false::(true::(false::(false::(false::(true::(true::(true::(false::(true::(false::(true::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(true::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(false::(true::[])))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
