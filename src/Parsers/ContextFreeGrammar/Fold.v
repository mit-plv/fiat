...
Section general_fold.
  ...
  Proof.
    unfold opt_Lookup_idx, Lookup_idx, compiled_productions.
...
Section fold_correctness.
  ...
  Section step.
    ...
    Lemma fold_nt_step_correct0
      ...
      : forall nt nt_idx,
        ...
        -> Pnt valid0 nt (fold_nt_step 0 fold_nt valid0 nt nt_idx).
    Proof.
  ...
  Lemma fold_cnt'_correct
    ...
    : forall nt nt_idx,
      of_nonterminal nt = nt_idx
      -> Pnt valid0 nt (fold_cnt' valid0_len valid0 nt nt_idx).
  Proof.
    ...
    { simpl.
      ...
      { apply Pnt_lift; [ subst; assumption.. | ].
        rewrite eq_opt_Lookup_idx, <- list_to_productions_to_nonterminal.
