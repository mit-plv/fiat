...
Section cfg.
  ...
  Proof.
    ...
    { specialize (parse_empty_pb_parse_of_productions valid0 (G nt) str Hlen p (snd Hforall)).
  ...
  Definition parse_empty_pb_parse_of_item
             ...
             (Hforall : Forall_parse_of_item (fun _ nt' => is_valid_nonterminal valid0 nt') p)
  : pb_item G valid0 it
    := @parse_empty_pb_parse_of_item' (@parse_empty_pb_parse_of_productions) valid0 it str Hlen p Hforall.

  Definition parse_empty_minimal_pb_parse_of_item
             {valid0 it}
             (str : String) (Hlen : length str = 0) (p : parse_of_item G str it)
             (Hforall : Forall_parse_of_item (fun _ nt' => is_valid_nonterminal valid0 nt') p)
  ...
  Proof.
    ...
    eapply parse_empty_pb_parse_of_item; eassumption.
  Qed.

  Definition parse_empty_minimal_pb_parse_of_production
             {valid0 pat}
             (str : String) (Hlen : length str = 0) (p : parse_of_production G str pat)
             (Hforall : Forall_parse_of_production (fun _ nt' => is_valid_nonterminal valid0 nt') p)
  ...
  Proof.
    ...
    eapply parse_empty_pb_parse_of_production; eassumption.
  Qed.

  Definition parse_empty_minimal_pb_parse_of_productions
             {valid0 pats}
             (str : String) (Hlen : length str = 0) (p : parse_of G str pats)
             (Hforall : Forall_parse_of (fun _ nt' => is_valid_nonterminal valid0 nt') p)
  ...
  Proof.
    ...
    eapply parse_empty_pb_parse_of_productions; eassumption.
  Qed.

  Definition parse_empty_from_pb_parse_of_item'
             (parse_empty_from_pb_parse_of_productions
              : forall valid0 pats
  ...
  Proof.
    ...
    eapply parse_empty_from_pb_parse_of_productions in p; [ | eassumption.. ].
    exists (ParseNonTerminal _ (projT1 p)).
    exact (H, projT2 p).
  Defined.

  Fixpoint parse_empty_from_pb_parse_of_productions
             {valid0 pats}
             (str : String) (Hlen : length str = 0)
  ...
  : { p : parse_of G str pats
          & Forall_parse_of (fun _ nt' => is_valid_nonterminal valid0 nt') p }
  with parse_empty_from_pb_parse_of_production
         {valid0 pat}
         (str : String) (Hlen : length str = 0)
  ...
  Proof.
    { destruct p as [ ?? p | ?? p ]; simpl in *.
      { pose proof (parse_empty_from_pb_parse_of_production valid0 _ _ Hlen p) as p'.
        eexists (ParseHead _ (projT1 p')).
        exact (projT2 p'). }
      { pose proof (parse_empty_from_pb_parse_of_productions valid0 _ _ Hlen p) as p'.
        eexists (ParseTail _ (projT1 p')).
        exact (projT2 p'). } }
    { destruct p as [ | ?? p0 p1 ]; simpl in *.
      { exists (ParseProductionNil G _ Hlen). constructor. }
      { eapply (@parse_empty_from_pb_parse_of_item' parse_empty_from_pb_parse_of_productions) in p0.
        eapply (@parse_empty_from_pb_parse_of_production) in p1.
  ...
  : { p : parse_of_item G str it
          & Forall_parse_of_item (fun _ nt' => is_valid_nonterminal valid0 nt') p }
    := @parse_empty_from_pb_parse_of_item' (@parse_empty_from_pb_parse_of_productions) valid0 it str Hlen p.

  Definition parse_empty_from_minimal_pb_parse_of_item
             {valid0 it}
             (str : String) (Hlen : length str = 0)
  ...
  : { p : parse_of_item G str it
          & Forall_parse_of_item (fun _ nt' => is_valid_nonterminal valid0 nt') p }.
  Proof.
    eapply parse_empty_from_pb_parse_of_item; trivial.
    eapply pb_item__of__minimal_pb_item; try eassumption; reflexivity.
  Qed.

  Definition parse_empty_from_minimal_pb_parse_of_production
             {valid0 pat}
             (str : String) (Hlen : length str = 0)
  ...
  : { p : parse_of_production G str pat
          & Forall_parse_of_production (fun _ nt' => is_valid_nonterminal valid0 nt') p }.
  Proof.
    eapply parse_empty_from_pb_parse_of_production; trivial.
    eapply pb_production__of__minimal_pb_production; try eassumption; reflexivity.
  Qed.

  Definition parse_empty_from_minimal_pb_parse_of_productions
             {valid0 pats}
             (str : String) (Hlen : length str = 0)
  ...
  : { p : parse_of G str pats
          & Forall_parse_of (fun _ nt' => is_valid_nonterminal valid0 nt') p }.
  Proof.
    eapply parse_empty_from_pb_parse_of_productions; trivial.
