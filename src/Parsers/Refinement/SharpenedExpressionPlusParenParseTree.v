...
Definition parser_informative_opaque (str : Stdlib.Strings.String.string)
...
Definition parser_informative (str : Stdlib.Strings.String.string)
  : option (@simple_parse_of_item Ascii.ascii).
Proof.
  Time make_parser_informative ComputationalSplitter.
Defined.

Definition parser_eval (str : Stdlib.Strings.String.string)
  : option nat.
Proof.
