...
Section recursive_descent_parser.
  ...
  Class generic_parser_correctness_dataT {gendata : @generic_parser_dataT Char} :=
    { parse_nt_is_correct
      : forall (str : String)
      ...
      : Proper (beq ==> eq ==> eq ==> eq ==> impl) parse_nt_is_correct;
      parse_item_is_correct_Proper
      : Proper (beq ==> eq ==> eq ==> eq ==> impl) parse_item_is_correct;
      parse_production_is_correct_Proper
      : Proper (beq ==> eq ==> eq ==> eq ==> impl) parse_production_is_correct;
      parse_productions_is_correct_Proper
      : Proper (beq ==> eq ==> eq ==> eq ==> impl) parse_productions_is_correct;
  ...
  Section better_proper.
    ...
    Global Instance parse_nt_is_correct_Proper_useful
      : Proper (eq ==> beq ==> eq ==> eq ==> eq ==> Basics.flip impl) (@parse_nt_is_correct _).
    Proof. t. Qed.
    Global Instance parse_item_is_correct_Proper_useful
      : Proper (eq ==> beq ==> eq ==> eq ==> eq ==> Basics.flip impl) (@parse_item_is_correct _).
    Proof. t. Qed.
    Global Instance parse_production_is_correct_Proper_useful
      : Proper (eq ==> beq ==> eq ==> eq ==> eq ==> Basics.flip impl) (@parse_production_is_correct _).
    Proof. t. Qed.
    Global Instance parse_productions_is_correct_Proper_useful
      : Proper (eq ==> beq ==> eq ==> eq ==> eq ==> Basics.flip impl) (@parse_productions_is_correct _).
    Proof. t. Qed.
  End better_proper.
