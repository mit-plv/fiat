...
Proof.
  ...
  eapply CompileSeq; [ | repeat compile_compose]; unfold DnsCacheAsCollectionOfVariables; _packet_encode_t.
  ...
  Focus.
  _packet_encode_t.
  (* intros ? (? & ?) *; simpl; unfold encode_question. *)
