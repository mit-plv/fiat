...
(*
{
    ...
    (* subst_all; *)
    (* apply refine_under_bind_both; [ idtac | intros; higher_order_reflexivity ]. *)
...
Time auto. (* Cxb + finished transaction *)
}
*)
(*    simplify with monad laws.
...
*)
  ...
  pose_headings_all.
  (* TODO: rewrite with unit in automation, and move the filter rewrite *)
