...
Section i2list2.
  ...
  Inductive i2list2 : forall (As : list A), ilist B As -> Type :=
  | i2cons2 : forall a As (Bs : ilist B (a :: As))
                    (c : C (ilist_hd Bs)),
               i2list2 (ilist_tl Bs) -> i2list2 Bs
  | i2nil2 : forall Bs : ilist B nil, i2list2 Bs.
  ...
  Definition i2list2_hd (As : list A)
             (Bs : ilist B As)
             (i2l : i2list2 Bs) :
    match As return forall Bs : ilist B As, i2list2 Bs -> Type with
  ...
  Definition i2list2_tl (As : list A)
    ...
    match As as As' return
          forall Bs : ilist B As', i2list2 Bs -> Type with
      | a :: As' => fun Bs il => i2list2 (ilist_tl Bs)
      | nil => fun _ _ => unit
    end Bs i2l :=
    match i2l with
  ...
  : forall {a : A} {b : B a} (c : C b) (As : list A) (il : ilist B As) (i2l : i2list2 il), Prop :=
  | In2_hd : forall a' As (Bs : ilist B (a' :: As)) (i2l : i2list2 (ilist_tl Bs)) c,
              i2list2_In c (i2cons2 Bs c i2l)
  | In2_tl : forall a a' As (Bs : ilist B (a' :: As)) (b' : B a) c' (i2l : i2list2 (ilist_tl Bs)) (c : C b'),
              i2list2_In c i2l ->
              i2list2_In c (i2cons2 Bs c' i2l).

  (* Fixpoint siglist2i2list2 *)
  (*          (As : list A) *)
  (*          (il : ilist (fun a => sigT (@C a)) As) *)
  (* : i2list2 (imap _ (fun a => @projT1 _ (@C a)) il)  := *)
  (*   match il *)
  (*         return i2list2 (imap _ (fun a => @projT1 _ (@C a)) il) *)
  (*   with *)
  (*     | inil => i2nil2 *)
  (*     | icons a As' (existT b c) il' => i2cons2 c (siglist2i2list2 il') *)
  (*   end. *)

  (* (* and vice versa. *) *)
  (* Fixpoint i2list22siglist {As : list A} {Bs : ilist B As} *)
  (* (i2l : i2list2 Bs) *)
  (* : ilist (fun a => sigT (@C a)) As := *)
  (*   match i2l in @i2list2 As' Bs' return ilist (fun a => sigT (@C a)) As' with *)
  (*     | i2nil2 => @inil _ _ *)
  (*     | i2cons2 a As b Bs' c Cs' => *)
  (*       icons a (existT _ b c) (i2list22siglist Cs') *)
  (*   end. *)

  (* (* i2list22siglist is the inverse of siglist2i2list2 *) *)
  (* Lemma siglist2i2list2_id *)
  (* : forall As (Bs : ilist _ As), *)
  (*     i2list22siglist (siglist2i2list2 Bs) = Bs. *)
  (* Proof. *)
  ...
  (* i2list22siglist is the inverse of siglist2i2list2 *)
  Lemma i2list22siglist_id
  : forall As Bs (Cs : i2list2 Bs),
      siglist2i2list2 (i2list22siglist Cs) = Cs.
  Proof.
    induction Bs; simpl; auto.
    destruct b; simpl; congruence.
  Qed.
    ...
    with
      | 0 => fun Bs =>
               match Bs as Bs' return
                 ...
                 | inil => fun i2l => I
                 | icons a As' b Bs' => fun i2l => i2list2_hd i2l
               end
      | S n => fun Bs =>
                 match Bs as Bs' return
                       i2list2 Bs'
                   ...
                   | inil => fun i2l => I
                   | icons a As' b Bs' => fun i2l => i2th_error2 (i2list2_tl i2l) n
                 end
    end Bs i2l.
    ...
    match Bs as Bs' return i2list2 Bs' -> Prop with
      | icons a As b Bs' => fun Cs =>
                           exists (c : C b) (Cs' : i2list2 Bs'),
                             Cs = i2cons2 (icons a b Bs') c Cs'
      | inil => fun Cs => Cs = i2nil2 (inil _)
    end Cs.
  Proof.
    destruct Cs.
