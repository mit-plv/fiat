...
Section SequenceFormat.
  ...
  Proof.
    ...
    sequence_Decode, sequence_Format, compose, Compose_Format; split; intros.
  ...
  Proof.
    ...
    eapply (CorrectDecoder_sequence (fun s s' => f s = s')); eauto; intros;
      unfold Projection_Format, Compose_Format, sequence_Format, compose, Bind2, LaxTerminal_Format in *.
