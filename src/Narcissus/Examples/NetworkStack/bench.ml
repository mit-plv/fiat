...
let bench_dec () =
  (Fiat4Mirage.fiat_tcp_decode 338 http_response_tcp_decode_338_input (ArrayVector.of_array [|151L;101L;129L;164L|]) (ArrayVector.of_array [|192L;168L;1L;109L|]) (338L))

let bench_enc () =
  (Fiat4Mirage.fiat_tcp_encode 4096 http_response_tcp_encode_338_input (ArrayVector.of_array [|151L;101L;129L;164L|]) (ArrayVector.of_array [|192L;168L;1L;109L|]) (338L) (ArrayVector.of_array buf))
