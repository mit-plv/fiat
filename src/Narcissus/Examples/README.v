...
Module Sensor2.
  ...
  Let decode := decoder_impl enc_dec.
  (* The order of checking is not exactly the same as the one shown in paper,
     but they are functionally equal. *)
  Print decode.
End Sensor2.
...
Module Sensor5.
  ...
  Let decode := decoder_impl enc_dec.
  (* WO is the empty word. We present the simplified version in the paper to
     save space. *)
  Print decode.
End Sensor5.
