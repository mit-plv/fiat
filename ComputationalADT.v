...
Record ADTimpl (A : ADT) funcs denote_funcs :=
  {
    State : Type;
    ...
    MutatorMethodBodies : MutatorIndex A -> methodTypeD State funcs;
    (** An implementation of each mutator method *)

    ObserverMethodBodies : ObserverIndex A -> methodTypeD State funcs;
