...
Section general_refine_lemmas.
  ...
  Definition remove_forall_eql_and A x B (P : A -> B -> Prop) (Q : A -> Prop)
  : pointwise_relation _ (flip impl)
                       (fun z => forall y : A, (y = x /\ Q y) -> P y z) (fun z => Q x -> P x z).
  Proof. t_refine. Qed.
  ...
  Definition remove_forall_eqr_and A y B (P : A -> B -> Prop) (Q : A -> Prop)
  : pointwise_relation _ (flip impl)
                       (fun z => forall x : A, (x = y /\ Q y) -> P y z) (fun z => Q y -> P y z).
  Proof. t_refine. Qed.
  ...
  (** Now when we flip the equality and the /\ *)
  Definition remove_exists_eql_and A B x (P : A -> B -> Prop)
  : pointwise_relation _ (flip impl) (fun z => exists y : A, y = x z /\ P y z) (fun z => P (x z) z).
  Proof. t_refine. Qed.

  Definition remove_exists_eql_and' A B x (P : A -> B -> Prop)
  : pointwise_relation _ impl (fun z => exists y : A, y = x z /\ P y z) (fun z => P (x z) z).
  Proof. t_refine. Qed.

  Definition remove_exists_eqr_and A B x (P : A -> B -> Prop)
  : pointwise_relation _ (flip impl) (fun z => exists y : A, x z = y /\ P y z) (fun z => P (x z) z).
  Proof. t_refine. Qed.

  Definition remove_exists_eqr_and' A B x (P : A -> B -> Prop)
  : pointwise_relation _ impl (fun z => exists y : A, x z = y /\ P y z) (fun z => P (x z) z).
  Proof. t_refine. Qed.
