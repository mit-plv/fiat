...
Definition BookStorage : @BagPlusBagProof Book.
  mkIndex BookSchema (@nil (Attributes (GetNRelSchemaHeading (qschemaSchemas BookStoreSchema) Books))).
Defined.

Definition OrderStorage : @BagPlusBagProof Order.
  mkIndex OrderSchema (@nil (Attributes (GetNRelSchemaHeading (qschemaSchemas BookStoreSchema) Books))).
Defined.
